...
OBSTACLE_TEMPLATE_MATCH_THRESHOLD = 0.80
OBSTACLE_TEMPLATE_MARGIN = 0.02
FOOTBALL_TEMPLATE_MATCH_THRESHOLD = 0.60
FOOTBALL_TEMPLATE_MARGIN = 0.02
ALARM_TEMPLATE_FILENAME = "alarm_xor_template.png"
TRAFFIC_TEMPLATE_FILENAME = "traffic_light_xor_template.png"
MUSIC_TEMPLATE_FILENAME = "music_xor_template.png"
OBSTACLE_TEMPLATE_FILENAME = "obstacle_xor_template.png"
MAZE_TEMPLATE_FILENAME = "maze_xor_template.png"
FOOTBALL_TEMPLATE_FILENAME = "football_xor_template.png"
...
def classify_sign_symbol(frame_bgr, sign_roi):
    ...
    templates = {
        ...
        "MAZE": load_sign_template(MAZE_TEMPLATE_FILENAME),
        "FOOTBALL": load_sign_template(FOOTBALL_TEMPLATE_FILENAME),
    }
    ...
    if (
        ...
        and best_score < SIGN_TEMPLATE_MATCH_THRESHOLD
        and (
    ...
    football_score = scores.get("FOOTBALL", -1.0)
    other_than_football_best = max([score for label, score in scores.items() if label != "FOOTBALL"], default=-1.0)

    if (
        football_score >= FOOTBALL_TEMPLATE_MATCH_THRESHOLD
        and football_score >= other_than_football_best + FOOTBALL_TEMPLATE_MARGIN
    ):
        return {
            "label": "FOOTBALL",
            "confidence": football_score,
            "reason": "xor_template_match_football",
            "binary": binary,
            "match_score": football_score,
            "scores": scores,
        }
